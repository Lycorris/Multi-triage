...
class SparceBCELoss(nn.Module):
    ...
    def __init__(self, avg_label_types, total_label_types, miu=0.14, sigma=0.10, *args, **kwargs):
...
class SupConLoss(nn.Module):
    """
    SupConLoss from https://github.com/HobbitLong/SupContrast/blob/master/losses.py
